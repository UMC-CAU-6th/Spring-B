...
public enum ErrorStatus implements BaseErrorCode {
    ...
    MISSION_IS_CHALLENGING(HttpStatus.BAD_REQUEST,"MISSION4001","도전 중인 미션입니다."),
    PAGE_EXCEPTION(HttpStatus.BAD_REQUEST,"PAGE4001","페이지 범위가 너무 작습니다."),

    // 예시,,,
    ARTICLE_NOT_FOUND(HttpStatus.NOT_FOUND, "ARTICLE4001", "게시글이 없습니다."),
    FOOD_CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND, "FOODCATEGORY4001", "존재하지 않는 카테고리입니다." ),
    ...
    MEMBER_MISSION_NOT_FOUND(HttpStatus.NOT_FOUND, "MEMBERMISSION4001", "존재하지 않는 가게입니다." );
